  ...
  <div class="card card-primary">
    ...
    <form role="form" method="post" action="TopicsEditServlet">
      <div class="card-body">
        ...
        <div class="form-group">
          <label for="order_edit">Kolejność</label>
          <input type="text" class="form-control" name="order" id="order_edit" placeholder="Order" value="${topicLayer2.getOrderId()}">
        </div>
        <div class="form-group">
          <label for="comment_edit">Komentarz (niewidoczny na stronie)</label>
          <input type="text" class="form-control" name="comment" id="comment_edit" placeholder="Comment"
  ...
  <div class="card card-primary">
    ...
    <form role="form" method="post" action="TopicsEditServlet">
      <div class="card-body">
        ...
        <div class="form-group">
          <label for="order_edit">Kolejność</label>
          <input type="text" class="form-control" name="order" id="order_edit" placeholder="Order" value="${topicLayer3.getOrderId()}">
        </div>
        <div class="form-group">
          <label for="comment_edit">Komentarz (niewidoczny na stronie)</label>
          <input type="text" class="form-control" name="comment" id="comment_edit" placeholder="Comment"
  ...
  <div class="card card-primary">
    ...
    <form role="form" method="post" action="TopicsEditServlet">
      <div class="card-body">
        ...
        <div class="form-group">
          <label for="order_edit">Kolejność</label>
          <input type="text" class="form-control" name="order" id="order_edit" placeholder="Order" value="${topicLayer4.getOrderId()}">
        </div>
        <div class="form-group">
          <label for="comment_edit">Komentarz (niewidoczny na stronie)</label>
          <input type="text" class="form-control" name="comment" id="comment_edit" placeholder="Comment"
